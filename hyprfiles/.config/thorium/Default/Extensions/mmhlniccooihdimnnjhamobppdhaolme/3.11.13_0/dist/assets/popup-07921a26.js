import { b as browserPolyfillExports, $ as $STR, d as browser, e as $ } from "./DollarPolyfills-e1e75c6d.js";
import { o as openBlock, c as createElementBlock, a as createBaseVNode, _ as _export_sfc, r as resolveComponent, b as createBlock, w as withCtx, d as createVNode, e as createTextVNode, t as toDisplayString, f as renderList, F as Fragment, u as useStore, m as mapState, g as withKeys, h as withModifiers, i as createCommentVNode, n as normalizeStyle, j as mergeProps, k as withDirectives, v as vShow, P as PasswordGenerator, l as __unplugin_components_1$2, p as __unplugin_components_2$2, q as createSlots, s as reactive, x as normalizeClass, y as createPinia, z as createApp, A as h, B as createVuetify, C as components, D as directives, I as IPCPiniaPlugin } from "./IPCPiniaPlugin-cd3ffaf7.js";
import { c as configManager, K as KeeLog, p as punycode } from "./ConfigManager-21f0f76b.js";
import { P as Port } from "./port-60653e1b.js";
import { S as SearcherAll, K as KeeURL, r as resolveConfig, c as calculateMatchScore, t as tokenise, D as DatabaseSummary } from "./SearcherAll-815f108b.js";
import { c as copyStringToClipboard } from "./copyStringToClipboard-aa1005c2.js";
import { F as Field$1, a as EntrySummary, T as TemporaryIDString, E as Entry$1, G as GroupSummary, b as Group, L as Locator } from "./Database-95399186.js";
...
const _hoisted_2$d = /* @__PURE__ */ createBaseVNode("path", {
  fill: "currentColor",
  d: "M10 19h3v3h-3v-3m2-17c5.35.22 7.68 5.62 4.5 9.67c-.83 1-2.17 1.66-2.83 2.5C13 15 13 16 13 17h-3c0-1.67 0-3.08.67-4.08c.66-1 2-1.59 2.83-2.25C15.92 8.43 15.32 5.26 12 5a3 3 0 0 0-3 3H6a6 6 0 0 1 6-6Z"
}, null, -1);
const _hoisted_3$b = [
  _hoisted_2$d
];
...
async function getAllFrameURLs(currentTab) {
  const frames = await browserPolyfillExports.webNavigation.getAllFrames({
    tabId: currentTab.id
  });
...
async function reconcileURLs(oldUrls, submittedUrl) {
  var _a;
  const currentTab = !submittedUrl ? (await browserPolyfillExports.tabs.query({ active: true, currentWindow: true }))[0] : null;
  ...
  methods: {
    ...
    async primaryClickAction() {
      if (this.entryIndex !== void 0) {
        ...
        const currentTab = await browserPolyfillExports.tabs.query({
          currentWindow: true,
          active: true,
          url: [
            "https://keevault.pm/*",
    ...
    loadInSameTab() {
      browserPolyfillExports.tabs.update({ url: this.entrySummary.url });
      window.close();
    },
    loadInNewTab() {
      browserPolyfillExports.tabs.create({ url: this.entrySummary.url });
      window.close();
    },
    manualFill() {
      Port.postMessage({
...
async function getFaviconUrl() {
  for (let i = 0; i < 45; i++) {
    const tab = (await browserPolyfillExports.tabs.query({ active: true, currentWindow: true }))[0];
    if (tab) {
...
const _sfc_main = {
  ...
  methods: {
    showOptions: () => {
      browserPolyfillExports.runtime.openOptionsPage();
      window.close();
    },
    saveStart: async function() {
      const currentTab = (await browserPolyfillExports.tabs.query({ active: true, currentWindow: true }))[0];
      if (!currentTab)
        return;
      const entryTemplate = {
        URLs: [currentTab.url],
    ...
    showHelp: () => {
      browserPolyfillExports.tabs.create({ url: "https://www.kee.pm/help" });
      window.close();
    },
