import { c as $$, $ as $STR, b as browserPolyfillExports } from "./DollarPolyfills-e1e75c6d.js";
...
function saveKPRPCPort(e) {
  ...
  configManager.save().then(() => browserPolyfillExports.runtime.sendMessage({ action: "KPRPC_Port_Change" }));
}
