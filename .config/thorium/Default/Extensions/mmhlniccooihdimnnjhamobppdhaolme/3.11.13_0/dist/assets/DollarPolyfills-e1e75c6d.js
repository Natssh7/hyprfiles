...
const browserPolyfill = /* @__PURE__ */ getDefaultExportFromCjs(browserPolyfillExports);
const browser = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: browserPolyfill
...
function $STRF(str, subs) {
  const msg = browserPolyfillExports.i18n.getMessage(str, subs);
  return msg || str;
}
export {
  $STR as $,
  $STRF as a,
  browserPolyfillExports as b,
  $$ as c,
  browser as d,
  $ as e
};
